                                                    ...
                                                    <ul class="nav nav-pills flex-column flex-lg-row" id="mainNav">
                                                        ...
                                                        <li class="dropdown"> <a class="dropdown-item dropdown-toggle"
                                                            ...
                                                            <ul class="dropdown-menu">
                                                                <li><a class="dropdown-item" href="#">Funders and
                                                                        Supporters</a>
                                                                </li>
                                                                <li><a class="dropdown-item" href="#">Photos/Videos</a>
                                                                </li>
                                                            </ul>
                                                        </li>
                                                        <li class="dropdown"> <a class="dropdown-item dropdown-toggle"
                    ...
                    <div class="col">
                        ...
                        <div class="row align-items-center pt-5 pb-3 appear-animation"
                            ...
                            <div class="col-md-4 px-5 px-md-3">
                                <img class="img-fluid scale-2 my-4" src="images/garden/miscellaneous1.jpg"
                                    alt="style switcher" />
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row py-5 my-4">
                    <div class="col-md-6 col-lg-4 mb-5 mb-lg-0">
                        ...
                        <p class="mb-0"><a href="#" class="btn-flat btn-xs text-color-light p-relative top-5"><strong
                    ...
                    <div class="col-md-6 col-lg-3 mb-5 mb-lg-0">
                        ...
                        <ul class="list-unstyled mb-0">
                            <li class="media mb-3 pb-1">
                                <a href="#">
                                    <img class="mr-3 rounded-circle" src="img/office/our-office-4-square.jpg" alt=""
                                        style="max-width: 70px;">
                                </a>
                                <div class="media-body">
                                    <a href="#">
                                        <p class="text-3 text-color-light opacity-8 mb-1">Lorem ipsum dolor sit,
                            ...
                            <li class="media">
                                <a href="#">
                                    <img class="mr-3 rounded-circle" src="img/office/our-office-5-square.jpg" alt=""
                                        style="max-width: 70px;">
                                </a>
                                <div class="media-body">
                                    <a href="#">
                            ...
                            <li class="mb-3 pb-1">
                                <a href="#">
                                    <p class="text-3 text-color-light opacity-8 mb-1"><i
                                            class="fas fa-angle-right text-color-primary"></i><strong class="ml-2">John
                                            Doe</strong> commented on <strong class="text-color-primary">lorem ipsum
                                            dolor sit amet.</strong></p>
                    ...
                    <div class="col-md-6 col-lg-2">
                        ...
                        <p>
                            <a href="#"><span
                                    class="badge badge-dark bg-color-black badge-sm py-2 mr-1 mb-2">DESIGN</span></a>
                            <a href="#"><span
                                    class="badge badge-dark bg-color-black badge-sm py-2 mr-1 mb-2">CODE</span></a>
                            <a href="#"><span
                                    class="badge badge-dark bg-color-black badge-sm py-2 mr-1 mb-2">LIFESTYLE</span></a>
                            <a href="#"><span
                                    class="badge badge-dark bg-color-black badge-sm py-2 mr-1 mb-2">BRANDS</span></a>
                            <a href="#"><span
                                    class="badge badge-dark bg-color-black badge-sm py-2 mr-1 mb-2">PROMO</span></a>
                        </p>
                    </div>
                </div>
            </div>
